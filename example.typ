...
随着科学研究的不断深入，规范的参考文献著录变得尤为重要。我国于 2015 年发布了 GB/T 7714—2015《信息与文献 参考文献著录规则》#super[@gb7714]，并于 2025 年进行了修订。本文档展示了使用 gb7714-bilingual 库进行参考文献管理的效果。
...
在学术写作中，专著是重要的参考来源。刘明和李华#super[@liu2015method]系统论述了科学研究方法论，而 Kopka 和 Daly#super[@kopka2004guide] 的 LaTeX 指南则是排版领域的经典著作。de Gaulle#super[@gaulle1970memoirs] 的回忆录记录了二战历史，Gates 等#super[@gates2021life]则讨论了气候问题。

学位论文同样是重要的学术资源。张伟#super[@zhang2018thesis]在其博士论文中深入探讨了深度学习在自然语言处理中的应用。

== 姓名特殊格式示例

本库正确处理西文姓名中的前缀（如 van, de）和后缀（如 Jr., III）。van Beethoven 和 Mozart#super[@beethoven2020music]探讨了音乐表达的本质，King Jr.#super[@king1963dream]的经典演讲被广泛研究。

连字符名的处理也符合标准：2015 版展开为空格分隔（J P），2025 版保留连字符（J-P）。Sartre#super[@sartre1946existentialism]的存在主义思想影响深远。

== 会议论文与报告

学术会议是知识交流的重要平台。Jones#super[@jones2019conference]在 ACL 2019 上发表了关于文本分类的研究成果。

技术报告则提供了更详尽的研究内容。中国科学院#super[@report2022]发布的人工智能发展报告对行业发展具有重要参考价值。

== 在线资源

随着互联网的普及，在线文献成为重要的信息来源。Typst 官方文档#super[@webpage2024]提供了完整的使用指南，Typst 0.10 发布公告#super[@webpage_with_date]展示了带发布日期的网页格式。预印本平台也成为学术交流的重要渠道，Brown 和 Smith#super[@online_article2023]在 arXiv 上发表了大语言模型综述。
